...
<div class="container-fluid">
    <a class="btn btn-dark" href="{{route('invps',$cod)}}"><i class="fas fa-undo-alt"></i> Atrás</a>
        ...
        <table class="table table-sm">
            ...
            <tbody>
                <tr>
					...
					<td><b>Diferencia</b> <a href="{{route('ver_d_m',$id)}}" data-toggle="tooltip" data-placement="top" title="Diferencias Positivas"><i class="fas fa-plus"></i></a> <a href="{{route('ver_dm',$id)}}" data-toggle="tooltip" data-placement="top" title="Diferencias Negativas"><i class="fas fa-minus"></i></a></td>
                    <td><b>Teorico</b></td>
                    <td><b>Fisico</b></td>
                    <td><b>Dañado</b></td>
                    <td></td>
            ...
            <tbody>
                ...
                <tr>
					...
					@if($vi->existencia_teorica >= 0 && $vi->existencia_fisica >= 0)
							...
							<td style="background-color: #DE7976;">{{number_format(($vi->existencia_fisica - $vi->existencia_teorica)*-1)}}</td>
							@else
					...
					@elseif($vi->existencia_teorica > 0 && $vi->existencia_fisica < 0)
							...
							<td style="background-color: #DE7976;">{{number_format(($vi->existencia_teorica + $vi->existencia_fisica)*-1)}}</td>
							@else
