    ...
    <div class="table-condensed">
        <table class="table table-sm">
            ...
            <tbody>
                ...
                <tr>
                    <td><a class="fas fa-check-square" href="{{route('scpro',array('cat'=>$tp->cod_tipo_prod,'semana'=>$semana))}}"></a>{{$tp->cod_tipo_prod}}</td>
                    <td><a class="fas fa-check-square" href="{{route('spro',array('id'=>$tp->id,'semana'=>$semana))}}"></a> {{$tp->nombre_corto}} {{$tp->nombre_fiscal}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
