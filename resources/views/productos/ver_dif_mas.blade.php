...
<div class="container-fluid">
    ...
    <a class="btn btn-dark" href="{{ route('pdf_dif_pos',array('id'=>$id))}}"><i class="fas fa-print"></i> PDF</a>
        ...
        <table class="table table-sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td><b>Diferencia</b> <a href="{{route('ver_dm',$id)}}" data-toggle="tooltip" data-placement="top" title="Diferencias Negativas"><i class="fas fa-minus"></i></a></td>
                    <td><b>Teorico</b></td>
                    <td><b>Fisico</b></td>
                    <td><b>Dañado</b></td>
                    <td></td>
            ...
            <tbody>
                ...
                @if($vi->existencia_fisica - $vi->existencia_teorica > 0 && $vi->existencia_fisica + $vi->existencia_teorica > 0)
                <tr>
                    <td>{{$vi->categoria}}</td>
