        ...
        <table class="table table-sm">
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$d->porcentaje}}%</td>
                    <td colspan="2"><a class="btn btn-danger" href="{{route('fin',array('id'=>$id,'suma'=>$suma))}}">Finalizar</a></td>
                    @else
                    <th scope="row">Realizado en</th>
                    <td>100%</td>
                    <td colspan="2"> <a class="btn btn-dark" href="{{ route('pdf',array('id'=>$id))}}"><i class="fas fa-print"></i> PDF</a></td>
                    @endif
                </tr>
                @endforeach
            </tbody>
