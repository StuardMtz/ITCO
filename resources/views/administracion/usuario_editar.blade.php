    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h6>Editar datos de usuario</h6>
            </div>
            <div class="card-body">
                @foreach ($usuario as $u)
                    <form class="needs-validation" novalidate method="post" action="{{ url('editus', $id) }}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="NombreUsuario"
                                        placeholder="Nombre de Usuario" name="name" value="{{ $u->name }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="sucursal" name="sucursal" required>
                                        <option value="{{ $u->cod_unidad }}">{{ $u->sucursal }}</option>
                                        @foreach ($sucursales as $sucursal)
                                            <option value="{{ $sucursal->cod_unidad }}" name="id">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="bodega" name="bodega" required>
                                        <option value="{{ $u->cod_bodega }}">{{ $u->bod }}</option>
                                    </select>
                                    <div class="valid-tooltip">
                                        Excelente!
                                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="rol" name="roles" required>
                                        <option value="{{ $u->rol }}">{{ $u->nomrol }}</option>
                                        @foreach ($roles as $r)
                                            @if ($r->rol == $u->rol)
                                            @else
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" value="{{ $u->no_identificacion }}"
                                        id="codigo" placeholder="No identificación" name="no_identificacion">
                                    <div class="valid-tooltip">
                                        Excelente!
                                    </div>
                                    <div class="invalid-tooltip">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Serie cotización"
                                        name="serie_cotizacion" value="{{ $u->serie_cotizacion }}">
                                    <div class="valid-tooltip">
                                        Excelente!
                                    </div>
                                    <div class="invalid-tooltip">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Código diamante"
                                        name="codigo_diamante" value="{{ $u->codigo_diamante }}">
                                    <div class="valid-tooltip">
                                        Excelente!
                                    </div>
                                    <div class="invalid-tooltip">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                @error('permisos')
                                    <span class="badge badge-pill badge-danger">No dejar el campo en blanco.</span>
                                @enderror
                                <select id="permisos" name="permisos[]" class="custom-select" multiple="multiple">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <button type="submit" class="btn btn-dark btn-block btn-sm" class="fas fa-save">Guardar
                                    cambios</button>
                            </div>
                        </div>
                    </form>
