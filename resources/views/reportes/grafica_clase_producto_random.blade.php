...
<div class="container-fluid">
    <a class="btn btn-dark btn-sm" href="{{route('grafClasSucR',['sucursal'=>$sucursal,'bodega'=>$bodega])}}"><i class="fas fa-arrow-left"></i> Atrás</a>
    <div class="row">
        <div class="col" id="graficaBarras"></div>
    </div>
