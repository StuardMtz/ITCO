...
<div class="container-fluid">
    ...
    <blockquote class="blockquote text-center">
        <p class="mb-0">Transferencias de exportación finalizadas</p>
    </blockquote>

    <form method="get" action="{{url('ffinexpor')}}" class="form-inline">
        ...
        <table class="table table-sm table-borderless" id="transferencias" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th colspan="4"><input type="text" id="column9_search" placeholder="Sale bodega" class="form-control"></th>
                </tr>
                <tr>
                    <th>Número</th>
                    <th>Sucursal</th>
