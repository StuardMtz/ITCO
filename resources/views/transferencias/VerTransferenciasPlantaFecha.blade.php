            ...
            <div class="navbar-nav">
                ...
                <form method="get" action="{{url('tran_otr_sucurf')}}">
                    <div class="input-group">
                        ...
                        <input type="date" aria-label="Fecha inicial" class="form-control col-form-label-sm" name="inicio" value="{{$inicio}}" required>
                        <div class="input-group-prepend">
                            <span class="input-group-text">Inicio</span>
                        </div>
                        <input type="date" aria-label="Fecha inicial" class="form-control col-form-label-sm" name="fin" value="{{$fin}}" required>
...
var table = $('#transferencias').DataTable({
    ...
    ajax:{
        url: "{{route('dat_trans_otro_sucf',['inicio'=>$inicio,'fin'=>$fin])}}",
        dataSrc: "data",
    },
    "order": [],
    lengthMenu: [
