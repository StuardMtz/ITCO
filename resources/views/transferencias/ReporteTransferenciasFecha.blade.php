    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link" href="{{route('rep_trans')}}">Atrás</a>
                <form method="get" action="{{url('RepTranF')}}" class="form-inline">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">De</span>
                        </div>
                        <input type="date" aria-label="Fecha inicial" class="form-control col-form-label-sm" name="inicio" required value="{{$inicio}}">
                    </div>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Hasta</span>
                        </div>
                        <input type="date" aria-label="Fecha inicial" class="form-control col-form-label-sm" name="fin" required value="{{$fin}}">
...
var table = $('#transferencias').DataTable({
    ...
    ajax:{
        url: "{{route('datos_rep_trans_f',['inicio'=>$inicio,'fin'=>$fin])}}",
        dataSrc: "data",
    },
    lengthMenu: [
        [ 100, 200, 300, -1 ],
