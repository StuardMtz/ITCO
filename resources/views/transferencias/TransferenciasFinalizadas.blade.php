...
<div class="container-fluid">
    ...
    <form method="get" action="{{url('FTranFe')}}" class="form-inline">
    ...
    <div class="table-responsive-sm">
        <table class="table table-sm table-borderless" id="transferencias" style="width:100%">
            <thead>
                <tr>
                    <th colspan="6"><input class="form-control" type="text" id="column2_search" placeholder="Bodega salida"></th>
                    <th colspan="4"><input class="form-control" type="text" id="column4_search" placeholder="Fecha salida"></th>
                    <th colspan="5"><input class="form-control" type="text" id="column7_search" placeholder="Placa"></th>
                </tr>
                <tr>
                    <th>Número</th>
                    <th>Sucursal</th>
...
var table = $('#transferencias').DataTable({
    ...
    ajax:{
        url: "{{route('datos_finalizadas_transf')}}",
        dataSrc: "data",
    },
    buttons: [
        {   extend: 'pageLength',
    ...
    "columnDefs": [
        ...
        { targets: [0,1,2,3,4,6,7,8,9,10,11,12], searchable: true },
