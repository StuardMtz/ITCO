    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link" href="{{route('lis_transf_mm')}}">Atrás</a>
	 			<a class="nav-link active">Existencias</a>
                ...
                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#Transferencia" id="modalb">
                    Nueva transferencia
                </button>
                @guest
                    <li class="nav-item">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" novalidate method="post" action="{{url('TransN',['sucursal'=>$sucursal,'bodega'=>$bodega])}}">
                    {{csrf_field()}}
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <button class="btn btn-dark btn-block" type="submit"><i class="fas fa-arrow-alt-circle-right"></i> Crear nueva transferencia</button>
                            </div>
                        </div>
                    </form>
                </div>
...
var table = $('#existencia').DataTable({
    ...
    searching: true,
    ajax:{
        url: "{{url('dat_exist',['sucursal'=>$sucursal,'bodega'=>$bodega])}}",
        dataSrc: "data",
    },
    "order": [[ 0,"asc" ]],
	dom: 'Bfrtip',
