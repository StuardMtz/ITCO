...
<div class="container-fluid">
    <ul class="nav nav-tabs">
		...
		<li class="nav-item">
    		<a class="nav-link" href="#" id="active"><i class="fas fa-arrow-circle-down"></i> Abajo del mínimo</a>
		</li>
		<li class="nav-item">
    		<a class="nav-link" href="{{route('existencia_sucursal',['sucursal'=>$sucu,'bodega'=>$bod,'todo'=>'3'])}}"><i class="fas fa-arrow-circle-down"></i> Abajo del reorden</a>
    	<li>
	</ul>
    <h4>Productos abajo del mínimo {{$sucursal->nombre}} {{$bodega->nombre}}</h4>
    ...
    var table = $('#existencia').DataTable({
        ...
        searching: true,
        ajax:{
            url: "{{url('dat_ase_exmin',['sucu'=>$sucu,'bod'=>$bod])}}",
            dataSrc: "data",
        },
        "order": [[ 0,"asc" ]],
		  dom: 'Bfrtip',
