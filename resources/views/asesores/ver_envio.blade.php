...
<div class="container-fluid">
  ...
  <a  class="btn  btn-warning btn-block" href="{{route('bit',$envio->id)}}"><i class="fas fa-user-plus"></i> Más</a>
  <a  class="btn  btn-warning btn-block" href="{{route('map',$envio->id)}}"><i class="fas fa-user-plus"></i> Ver Mapa</a>
</div>
@endsection
