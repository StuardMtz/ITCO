...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="{{route('reportes_usuarios',$id)}}">Atrás</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" id="active" disabled>Listado de actividades por fechas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('mp_vis_fecha',['id'=>$id,'inicio'=>$inicio,'fin'=>$fin])}}">Mapa visitas</a>
            </li>
            <form method="get" action="{{url('repUsF',$id)}}" class="form-inline">
                <div class="input-group">
                    ...
                    <input type="date" aria-label="Fecha inicial" value="{{$inicio}}" class="form-control" name="inicio">
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Fin</span>
                    </div>
                    <input type="date" aria-label="Fecha inicial" value="{{$fin}}" class="form-control" name="fin">
...
var table = $('#transferencias').DataTable({
    ...
    "stateDuration": 300,
    ajax:{
        url: "{{url('drepUsF',['id'=>$id,'inicio'=>$inicio,'fin'=>$fin])}}",
        dataSrc: "data",
    },
    "order": [[ 3,"desc" ]],
    "language": {
