    ...
    <div class="collapse navbar-collapse" id="transCompras">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item active">
                <a class="nav-link" id="active" disabled>Todas los días registrados</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('lis_td_ac_fe')}}">Mapa visitas</a>
            </li>
...
<div class="container-fluid">
    <blockquote class="blockquote text-center">
        <p class="mb-0">Listado de días registrados por usuarios</p>
    </blockquote>
