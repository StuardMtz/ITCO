...
@foreach($tran as $t)
    <ul class="nav nav-tabs">
        @if($t->id_estado == 16)
        <li class="nav-item">
			<a class="nav-link bg-light" href="{{route('SFTran',$id)}}"><b><i class="fas fa-arrow-left"></i> Atrás</b></a>
        </li>
        @elseif($t->id_estado >= 17 && $t->id_estado <= 18)
        <li class="nav-item">
			<a class="nav-link bg-light" href="{{route('SFTran',$id)}}"><b><i class="fas fa-arrow-left"></i> Atrás</b></a>
        </li>
        @else
		<li class="nav-item">
            <a class="nav-link bg-light" href="javascript:history.go(-1)"><b><i class="fas fa-arrow-left"></i> Atrás</b></a>
        </li>
        @endif
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link bg-light" href="{{route('ISTran',$id)}}"><b><i class="fas fa-print"></i> Imprimir</b></a>
        </li>
	</ul>
	<div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <b>Carga preparada:</b>
                    @else
                    <b>Carga preparada:</b> {{date('d/m/Y H:i:s',strtotime($t->fecha_cargado))}}
                    @endif
                </div>
                <div class="col">
                    @if($t->fechaSalida == '')
