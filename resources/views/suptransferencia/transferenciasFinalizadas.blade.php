...
<div class="container-fluid">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('SFTran')}}" id="active"><i class="fas fa-clipboard-check"></i> Transferencias finalizadas</a>
        </li>
    </ul>
...
<script>
    ...
    $('#sucursales').on('click','tbody tr', function(){
      ...
      window.location.href =(url_global+'/VSTran/'+row.data().num_movi);
