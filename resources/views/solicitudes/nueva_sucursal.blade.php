...
@section('content')
    ...
    <hr>
    <div class="container-fluid">
        {!! Form::open(['route' => 'g_sucursal', 'before' => 'csrf', 'method' => 'post']) !!}
        <form>
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="cod_unidad" required>
            ...
            <div class="row justify-content-md-center">
                <button type="submit" id="boton" class="btn btn-success btn-block" class="fas fa-save"><b
