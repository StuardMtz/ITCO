...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link" href="{{route('entregas_x_camion',$id)}}">Atrás</a>
                <a class="nav-link" href="#"><i class="fas fa-clipboard-check"></i> Historial de entregas</a>
                <a class="nav-link" href="{{route('mapa_camion_fecha',['id'=>$id,'inicio'=>$inicio,'fin'=>$fin])}}"><i class="fas fa-map-marked"></i> Mapa entregas</a>
                <form method="get" action="{{url('fenpcam',$id)}}">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="span">Desde</span>
                        </div>
                        <input type="date"  class="form-control" placeholder="Inicio" name="inicio" value="{{$inicio}}" required>
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="span">Hasta</span>
                        </div>
                        <input type="date" step="0.01" class="form-control" placeholder="Fin" name="fin" value="{{$fin}}" required>
    ...
    <blockquote class="blockquote text-center">
        <p class="mb-0">Reporte de entregas por camion</p>
    </blockquote>
    <div class="container">
...
var table = $('#entregas').DataTable({
    ...
    stateSave:      true,
    ajax:{
        url: "{{url('dfendcam',$id)}}/"+ "{{$inicio}}/"+"{{$fin}}",
        dataSrc: "data",
    },
    dom: 'Bfrtip',
    lengthMenu: [
