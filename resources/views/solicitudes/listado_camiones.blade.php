    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link" href="{{route('listado_sucursales_reporte')}}">Sucursales</a>
                <a class="nav-link" href="{{route('entregas_por_municipio')}}"> Entregas por municipio</a>
                <a class="nav-link" href="#">Entregas por camión</a>
...
var table = $('#sucursales').DataTable({
    ...
    stateSave:      true,
    ajax:{
        url: "{{route('datos_listado_camiones')}}",
        dataSrc: "data",
    },
    "order": [[ 0,"asc" ]],
    "language": {
    ...
    columns: [
        ...
        //{ data: 'tipo_camion', name: 'tipo_camion'}
    ],
    "columnDefs": [
...
$('#sucursales').on('click','tbody tr', function(){
    ...
    window.location.href =(url_global+'/enpcam/'+row.data().id);
