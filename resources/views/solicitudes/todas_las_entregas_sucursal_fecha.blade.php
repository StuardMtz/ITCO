    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link" href="{{route('reporte_entregas_sucusal',$id)}}">Atrás</a>
                <a class="nav-link" href="#">Historial de {{$sucursal->name}}</a>
                <a class="nav-link" href="{{route('mapa_sucursal_fecha',['id'=>$id,'inicio'=>$inicio,'fin'=>$fin])}}">Mapa entregas</a>
...
var table = $('#entregas').DataTable({
    ...
    stateSave:      true,
    ajax:{
        url: "{{url('daentresufe',['id'=>$id,'inicio'=>$inicio,'fin'=>$fin])}}",
        dataSrc: "data",
    },
    dom: 'Bfrtip',
    lengthMenu: [
