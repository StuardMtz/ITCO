...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <a class="btn btn-dark" href="{{ route('e_p_cliente', $id) }}"><i class="fas fa-undo-alt"></i> Atrás</a>
        </div>
        <h4>Listado de Entregas</h4>
        <hr>
        <div class="row">
            <div class="col">
                {!! Form::open(['route' => ['b_c_solicitud', $id], 'method' => 'get']) !!}
            ...
            {!! Form::close() !!}
            <div class="col">
                {!! Form::open(['route' => ['b_e_solicitud', $id], 'method' => 'get']) !!}
                <div class="input-group">
                    <div class="input-group-prepend">
            ...
            {!! Form::close() !!}
            <div class="col">
                {!! Form::open(['route' => ['b_f_solicitud', $id], 'method' => 'get']) !!}
                <div class="input-group">
                    <div class="input-group-prepend">
